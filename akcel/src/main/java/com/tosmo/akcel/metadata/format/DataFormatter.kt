...
internal class DataFormatter(
    ...
    private fun getFormat(data: Double, dataFormat: Int, dataFormatString: String): Format {
        ...
        if (dataFormatString.contains(";") &&
            ...
            try {
                ...
                Log.w(
                    "${this::class}",
                    "Formatting failed for format $dataFormatString, falling back, $e"
                )
            }
        }
    ...
    private fun createDateFormat(pFormatStr: String): Format {
        ...
        return try {
            ...
            Log.d(
                ...
                "Formatting failed for format $formatStr, falling back, $iae"
            )
    ...
    private class InternalDecimalFormatWithScale(pattern: String, symbols: DecimalFormatSymbols?) :
        ...
        private fun scaleInput(obj: Any): Any {
            return divider?.let {
                when (obj) {
                    is BigDecimal -> obj.divide(divider, BigDecimal.ROUND_HALF_UP)
    ...
    private fun createNumberFormat(formatStr: String): Format {
        ...
        return try {
            ...
            Log.e("${this::class}", "Formatting failed for format $formatStr, falling back, $iae")
            // the pattern could not be parsed correctly,
            // so fall back to the default number format
            defaultFormat
        }
    ...
    companion object {
        ...
        fun setExcelStyleRoundingMode(format: DecimalFormat) {
            setExcelStyleRoundingMode(format, BigDecimal.ROUND_HALF_UP)
        }
         ...
         */
        fun setExcelStyleRoundingMode(format: DecimalFormat, roundingMode: Int) {
